...
(* Shared IR analyses (effect presence, tail-resume, loop/handler escape,
   needs_cps) — see lib/ir_analysis.ml. Hoisted out of this file in Phase 3
   [#11]; opened here so the existing call sites are unchanged. *)
open Ir_analysis
